...
\pagenumbering{arabic} In un ambiente con numerose reti senza fili
...
\bibitem{bib:dccp} ``RTP and the Datagram Congestion Control Protocol
  (DCCP)'' Internet Draft,
...
\bibitem{bib:wpa_supplicant} Linux WPA Supplicant (IEEE 802.1X, WPA,
  ...
  novembre 2009.
\bibitem{bib:srtp} M. Baughter, D. McGrew, M. Naslund, E. Carrara,
  K. Norrman, ``The Secure Real--Time Transport Protocol (SRTP)'', RFC
  3711, marzo 2004.
\bibitem{bib:zrtp} P. Zimmerman et al., ``ZRTP: Media Path Key
