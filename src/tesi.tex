...
operare sarà caratterizzato da un grado di libertà dei MN molto ampio
e gli handover saranno quindi molto frequenti. L'handover è per sua
natura un'operazione distruttiva che interrompe le comunicazioni
esistenti e richiede un tempo di completamento che può arrivare
all'ordine dei secondi. Tipicamente i passi che una NIC deve
completare per effettuare un handover sono:
\begin{enumerate}
