...
Un secondo motivo per cui l'interfaccia di rete può dover
ritrasmettere i pacchetti è la collisione tra frame spediti
simultaneamente da due o più MN.

\begin{figure}[tbh]
\includegraphics[width=\textwidth]{img/mona-collision-simulation}
\caption{TODO DESCRIZIONE IMG: schema dello scenario e grafico dei risultati}
