...
MIP handover usa una NIC, interruzione $\rightarrow$ packet loss.

Interferenze, contesa per accesso ad AP, collisioni, distanza AP
$\rightarrow$ packet loss (inerente al link)
...
Spiegazione meccanismo MAC ACK 802.11 $\rightarrow$ numero di
ritrasmissioni L2 metrica scelta.
...
Spiegazione simulazione $\rightarrow$ conclusione = packet loss
possono essere predetti contando le ritrasmissioni L2.
