...
\begin{defin}                           %crea l'ambiente definizione
Prima definizione. Ad esempio:
\begin{equation}\label{eq:uno}          %crea l'ambiente matematico
                                        %   equazione; questo ambiente
                                        %   centra la formula e la
                                        %   numera
\boldsymbol{f}(t,\boldsymbol{y}(t))=    %\boldsymbol grassetta i
                                        %   simboli matematici corsivi
{\setlength\arraycolsep{2pt}            %imposta la larghezza delle colonne
                                        %   dell'array che si va a fare
\left(\begin{array}{c}                  %apre ambiente array con un
                                        %   parentesi tonda grande davanti
f_1(t,y_1(t),y_2(t),\ldots,y_n(t))\\
f_2(t,y_1(t),y_2(t),\ldots,y_n(t))\\
\ldots\\
f_n(t,y_1(t),y_2(t),\ldots,y_n(t))
\end{array}\right)}
\end{equation}
\end{defin}
\begin{defin}\label{defin:due}          %crea l'ambiente definizione
                                        %   e mette una etichetta
Seconda definizione. Ad esempio:\\
Sia $f$ una funzione \ldots
\end{defin}
